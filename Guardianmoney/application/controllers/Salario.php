...
class Salario extends CI_Controller {
    ...
    public function ingresar(){
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                ...
                'usuario_id' => $this->session->userdata('user_id') // Aseg迆rate de que el ID del usuario est谷 en la sesi車n
            );
    ...
    public function presupuesto(){
        $this->form_validation->set_rules('categoria', 'Categor赤a', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                'usuario_id' => $this->session->userdata('user_id'), // Asumiendo que tienes el id del usuario en la sesi車n
    ...
    public function revision(){
        $user_id = $this->session->userdata('user_id'); // Obtener el ID del usuario de la sesi車n
    ...
    public function panel(){
        $this->load->view('salario/panel'); // Aseg迆rate de que esta vista cargue el panel correcto
    }
}
?>
